...
> 检索时间范围：**2026-04-10 至 2026-05-10**
> 共检索到 **16** 篇相关论文，按提交时间降序排列
...
## 2. Nature of magnetism in bilayer nickelate La3Ni2O7 single crystals
...
## 4. Vortex Transport in Ni/Bi Bilayer Superconductor with Strong Spin-Orbit and Exchange Interaction
...
## 5. Metallic crossover through the tilt-free transition in La$_3$Ni$_2$O$_7$ at high pressure and temperature
...
## 6. $3d_{z^2}$ orbital delocalization and magnetic collapse in superconducting (La,Pr)$_3$Ni$_2$O$_{7-δ}$ films
...
## 7. Superconductivity in bilayer La$_3$Ni$_2$O$_7$: A review focusing on the strong-coupling Hund's rule assisted pairing mechanism
...
## 8. Superconductivity in Ruddlesden-Popper nickelates: a review of recent progress, focusing on thin films
...
## 9. Pairing Mechanism in Bilayer Nickelate La$_3$Ni$_2$O$_7$ Superconductors

- **提交日期**：2026-04-19
- **作者**：Xianxin Wu, Tao Xiang, Jiangping Hu
- **arXiv链接**：[http://arxiv.org/abs/2604.17181v1](http://arxiv.org/abs/2604.17181v1)
...
## 10. Ultrafast Magneto-Pressure Spectroscopy and Control of Correlated Phases in a Trilayer Nickelate
...
- **arXiv链接**：[http://arxiv.org/abs/2604.16611v1](http://arxiv.org/abs/2604.16611v1)
...
## 11. Interlayer hybridization enables superconductivity in bilayer nickelates
...
- **arXiv链接**：[http://arxiv.org/abs/2604.14701v2](http://arxiv.org/abs/2604.14701v2)
...
## 12. Controlling the Band Filling and the Band Width in Nickelate Superconductors
...
- **arXiv链接**：[http://arxiv.org/abs/2604.13875v1](http://arxiv.org/abs/2604.13875v1)
...
## 13. Raman response in superconducting multiorbital systems with application to nickelates

- **提交日期**：2026-04-13
- **作者**：Matías Bejas, Jun Zhan, Xianxin Wu, Andreas P. Schnyder, Andrés Greco
- **arXiv链接**：[http://arxiv.org/abs/2604.11997v1](http://arxiv.org/abs/2604.11997v1)
...
## 14. Decoding Superconductivity in La$_3$Ni$_2$O$_{7-δ}$ Thin Films via Ozone-Driven Structure and Oxidation Tuning
...
- **arXiv链接**：[http://arxiv.org/abs/2604.09807v1](http://arxiv.org/abs/2604.09807v1)
...
## 15. High-temperature superconductivity in Nd$_{0.85}$Sr$_{0.15}$NiO$_2$ membranes under pressure

- **提交日期**：2026-04-10
- **作者**：Yonghun Lee, Mengnan Wang, Xin Wei, Yijun Yu, Wendy L. Mao, Yu Lin, Harold Y. Hwang
- **arXiv链接**：[http://arxiv.org/abs/2604.09525v1](http://arxiv.org/abs/2604.09525v1)
...
## 16. Pressure-Induced Superconducting-like Transition in the $\it d$-wave Altermagnet Candidate CsV$_2$Se$_2$O
...
- **arXiv链接**：[http://arxiv.org/abs/2604.09457v1](http://arxiv.org/abs/2604.09457v1)
